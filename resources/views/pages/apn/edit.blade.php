                   ...
                   <div class="card">
                       <div class="card-body">
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="apn_name" id="apn_name">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="apn" class="col-md-2 col-form-label">APN</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="apn" id="apn">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="proxy" class="col-md-2 col-form-label">Proxy</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="proxy" id="proxy">
                               </div>
                           </div>
                           <div class="mb-3 row">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="mmsc" id="mmsc">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="mms_proxy" class="col-md-2 col-form-label">MMS Proxy</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="mms_proxy" id="mms_proxy">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="mms_port" class="col-md-2 col-form-label">MMS Port</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="mms_port" id="mms_port">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="mcc" class="col-md-2 col-form-label">MCC</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="mcc" id="mcc">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="mnc" class="col-md-2 col-form-label">MNC</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="mnc" id="mnc">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="auth_type" class="col-md-2 col-form-label">Auth Type</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="auth_type" id="auth_type">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="apn_type" class="col-md-2 col-form-label">APN Type</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="apn_type" id="apn_type">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="apn_roaming" class="col-md-2 col-form-label">APN Roaming</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="apn_roaming" id="apn_roaming">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="bearer" class="col-md-2 col-form-label">Bearer</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="bearer" id="bearer">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="mvno_type" class="col-md-2 col-form-label">MVNO Type</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="mvno_type" id="mvno_type">
                               </div>
                           </div>
                           <div class="mb-3 row">
                               <label for="mvno_value" class="col-md-2 col-form-label">MVNO Value</label>
                               <div class="col-md-10">
                                   <input class="form-control" type="text" name="mvno_value" id="mvno_value">
                               </div>
                           </div>
                           <div>

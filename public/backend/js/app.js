    ...
    document.getElementById("header-lang-img") &&
      ("en" == e
        ? (document.getElementById("header-lang-img").src =
            "public/backend/images/flags/us.jpg")
        : "sp" == e
        ? (document.getElementById("header-lang-img").src =
            "public/backend/images/flags/spain.jpg")
        : "gr" == e
        ? (document.getElementById("header-lang-img").src =
            "public/backend/images/flags/germany.jpg")
        : "it" == e
        ? (document.getElementById("header-lang-img").src =
            "public/backend/images/flags/italy.jpg")
        : "ru" == e &&
          (document.getElementById("header-lang-img").src =
            "public/backend/images/flags/russia.jpg"),
      localStorage.setItem("language", e),
      null == (t = localStorage.getItem("language")) && a(n),
      s.getJSON("public/backend/lang/" + t + ".json", function (e) {
        s("html").attr("lang", t),
  ...
  function r(e) {
    1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (s("html").removeAttr("dir"),
        ...
        s("#app-style").attr("href", "public/backend/css/app.min.css"),
      ...
      ? (s("html").removeAttr("dir"),
        ...
        s("#bootstrap-style").attr(
          "href",
          "public/backend/css/bootstrap-dark.min.css"
        ),
        s("#app-style").attr("href", "public/backend/css/app-dark.min.css"),
      ...
      ? (s("#light-mode-switch").prop("checked", !1),
        ...
        s("#bootstrap-style").attr(
          "href",
          "public/backend/css/bootstrap-rtl.min.css"
        ),
        s("#app-style").attr("href", "public/backend/css/app-rtl.min.css"),
        s("html").attr("dir", "rtl"),
      ...
      : 1 == s("#dark-rtl-mode-switch").prop("checked") &&
        ...
        s("#bootstrap-style").attr(
          "href",
          "public/backend/css/bootstrap-dark-rtl.min.css"
        ),
        s("#app-style").attr("href", "public/backend/css/app-dark-rtl.min.css"),
        s("html").attr("dir", "rtl"),
